...
if ($appt) {
    ...
    while ($appt) {
        ...
        ?>
        <td>
            <form method=post action="../edit_advisor_appointment.php">
                <?php echo "<input type=hidden name='ID' value=$apptID />"; ?>
                <input type=submit value="Edit" name="editAppointment"/>
            </form>
            <form method=post action="../cancel_advisor_appointment.php">
                <?php echo "<input type=hidden name='ID' value=$apptID />"; ?>
                <input type=submit value="Cancel" name="cancelAppointment"/>
            </form>
        </td>
        <?php
        echo "</tr>";
