...
<body id="background">
<left>
    <div id="wrapper" style="margin: 0 auto; position: relative; top:10px; left:0;">
        <h1>CMNS Advising</h1>
            ...
            <table border="0" ;>
                <tr>
                    <form action="processSearchPage.php" method="post" name="Home">
                        <td><input type="submit" name="next" class="button main selection" value="Group appointment">
                        </td>

                        <td><input type="submit" name="next" class="button main selection" value="Date of appointment">
                        </td>
        ...
        if ($searchVar != "") {
            ...
            if ($appt) {
                ...
                if ($searchVar == "group") {
                    $sql = "SELECT * FROM appointments ORDER BY isGroup ASC";
                    $rs = mysql_query($sql, $conn);
                    ...
                    $sql = "SELECT * FROM appointments ORDER BY SessionLeader ASC";
                    $rs = mysql_query($sql, $conn);
